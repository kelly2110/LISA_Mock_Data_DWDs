...
def chi_squared(params, frequencies, powerspectrum, mean_sample_data, standard_deviation):
    ...
    chi_2 = (((mean_sample_data - GW_model) / standard_deviation)**2)
...
Omega_GW = calculate_S(frequencies, N_c, powerspectrum, powerspectrum.Amp, powerspectrum.fp_0())
mean_sample_data = np.mean(Omega_GW, axis=1)
standard_deviation = np.std(Omega_GW, axis=1)
