...
from noise import lisa_noise_1
...
for temp in temperature_values:
    for i, alpha in enumerate(alpha_values):
        for j, vw in enumerate(vw_values):
                ...
                Noise = lisa_noise_1(frequencies, 7.44e-14, 2.96e-7, -1.98, -2.6, 3, 15)
                ...
                data_parameters = np.array([[A_opt_0, A_opt, P_opt_0, P_opt, A1_opt_0, A1_opt, A2_opt_0, A2_opt, alpha1_opt_0, alpha1_opt, alpha2_opt_0, alpha2_opt, power_spectrum_object.Amp, Amp_opt, power_spectrum_object.fp_0(), fp_opt]])
                ...
                header_parameters = ["A_opt_noise", "A_opt_n+s", "P_opt_noise", "P_opt_n+s", "A1_opt_noise", "A1_opt_n+s", "A2_opt_noise", "A2_opt_n+s", "alpha1_opt_noise", "alpha1_opt_n+s", "alpha2_opt_noise", "alpha2_opt_n+s", "initial_Amp", "Amp_opt", "initial_peak", "fp_opt_signal"]
