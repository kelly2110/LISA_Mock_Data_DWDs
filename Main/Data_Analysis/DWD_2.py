...
for temp in temperature_values:
    for i, alpha in enumerate(alpha_values):
        for j, vw in enumerate(vw_values):
                ...
                parameters_data[index] = [alpha, vw, temp, A_opt_0, A_opt, P_opt_0, P_opt, alpha_opt_0, alpha_opt, beta_opt_0, beta_opt, kappa_opt_0, kappa_opt, gamma_opt_0, gamma_opt, Amp_opt, fp_opt]
                index += 1
...
header_parameters = ["Alpha", "vw", "Temperature", "A_opt_noise", "A_opt_n+s", "P_opt_noise", "P_opt_n+s", "alpha_opt_noise", "alpha_opt_n+s", "beta_opt_noise", "beta_opt_n+s", "kappa_opt_noise", "kappa_opt_n+s", "gamma_opt_noise", "gamma_opt_n+s", "Amp_opt", "fp_opt_signal"]
